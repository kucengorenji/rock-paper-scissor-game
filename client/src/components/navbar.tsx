            ...
            <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-3 text-white mx-24">
                ...
                <div className="inline-block lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow">
                        <Link to={"/register"} className="hover:bg-gray-500 p-2 rounded-lg block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                            REGISTER
                        </Link>
                        <Link to={"/login"} className="hover:bg-gray-500 p-2 rounded-lg block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                            LOGIN
                        </Link>
                    </div>
                </div>
